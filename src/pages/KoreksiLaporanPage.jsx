                                ...
                                <tbody className="divide-y divide-gray-100 text-gray-600">
                                    {koreksiHistory.map((item) => {
                                        ...
                                        if (item.status === 'Approved') {
                                            statusBadge = <span className="px-2.5 py-0.5 text-xs font-bold rounded-full bg-green-50 text-green-700 border border-green-200 shadow-sm">Disetujui</span>;
                                        } else if (item.status === 'Rejected') {
                                            const rejectionReason = item.catatan_admin || item.catatan || 'Tidak ada catatan spesifik.';
                                            statusBadge = (
                                                <div className="relative group inline-block">
                                                    <span className="px-2.5 py-0.5 text-xs font-bold rounded-full bg-red-50 text-red-700 border border-red-200 shadow-sm cursor-help inline-flex items-center gap-1">
                                            ...
                                            statusBadge = <span className="px-2.5 py-0.5 text-xs font-bold rounded-full bg-yellow-50 text-yellow-700 border border-yellow-200 shadow-sm">Menunggu</span>;
                                        }
